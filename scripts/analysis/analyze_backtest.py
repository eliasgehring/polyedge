...
def get_latest_run_filepath() -> str:
...
def load_run_metadata():
    metadata_path = RUN_METADATA_FILE
...
def build_leaderboard():
    ...
    for file in os.listdir(logs_dir):
        ...
        row = {
            ...
            "dataset_markets": meta.get("dataset_markets", ""),
            "dataset_hard_fail": meta.get("dataset_hard_fail", ""),
...
if __name__ == "__main__":
    filepath = get_latest_run_filepath()    
